...
<select>
<option value="gr-page3.php" selected>DEU</option>
<option value="page3.php">ENG</option>
</select>
</div>
    ...
    <div class="page-3_stage">
        <section class="section1">
            <div class="left-content">
                <h3>Warum es wichtig ist, ein nachhaltiges Menü <br> anzubieten</h3>
            </div>
        ...
        <div class="section3-grid">
            <ul>
                <li><p>Vorteile</p></li>
                <li></li>
                <li><p>Leicht veränderbar je nach Jahreszeit</p></li>
                <li></li>
                <li><p>Kosten sparen mit pflanzlichen Gerichten</p></li>
                <li></li>
                            </ul>
            <ul>
                <li></li>
                <li><p>Höherer Gewinn durch besseres Fleisch</p></li>
                <li></li>
                <li><p>Abheben von der Konkurrenz</p></li>
                <li></li>
                <li><p>Mit gesellschaft-lichen Trends gehen</p></li>
                            </ul>
            <ul>
                <li><p>Neue Kundinnen und Kunden ansprechen</p></li>
                <li></li>
                <li><p>Stabiles, rentables Geschäft</p></li>
                <li></li>
                <li><p>Belebung der lokalen Wirtschaft</p></li>
                <li></li>
                            </ul>
            <ul>
                <li></li>
                <li><p>Abwechslungs-reiche und köstliche Gerichte</p></li>
                <li></li>
                <li><p>Positive Auswirkungen auf die lokale Gäste und Umwelt</p></li>
                <li></li>
                <li><p></p></li>
                            </ul>
        </div>
        ...
        <section class="section4">
            <div class="left-content">
                <h3><a href="gr-page4.php" target="_self">MIT EINFACHEN SCHRITTEN ZUR NACHHALTIGEN SPEISEKARTE </a></h3>
                ...
                <li>Vermeiden Sie stark verarbeitete Zutaten</li>
                <li>Vermeiden Sie stark verarbeitete Zutaten
(haben mehrere Verarbeitungsschritte durchlaufen und enthalten viele Zutaten und Zusatzstoffe)
</li>
                 </ul>
                 ...
                 <div class="read-wrap">
                <a href="gr-page4.php" class="read-more" target="_self">Weiterlesen</a>
                </div>
            </div>
            <div class="right-content">
                ...
                <ul>
                  <li>
                       <a href="https://www.menukithd.com/" target="_blank"> <img src="images/logo-dish.png" /></a>
                        ...
                        <li>
                        <a href="https://dataentry.protrace.metrosystems.net/"  target="_blank">  <img src="images/Protrace_Logo-ai.svg" /></a>
                        </li>
                        <li>
