...
<header>
    <div class="container">
        <div class="logo">
        <a href="page1.php"> <img src="images/metro-logo.svg" /></a>
        </div>
...
<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <div class="overlay-content">
    ...
    <a href="javascript:void(0)" class="btn-changing">My Sustainable Restuarant</a>
    <a href="page2new.php">The MSR Chapter Guide</a>
    <a href="page3.php">Introduction to Sustainable Menu</a>
	<a href="page4.php">Explore Sustainable Menu</a>
  </div>
</div>
			</li>
                </ul>
...
<select>
  <option value="gr-page4.php">DEU</option>
  <option value="page4.php" selected>ENG</option>
</select>
</div>
        </div>
    </div>
    ...
    <div class="page-3_stage page-4_stage">
        <section class="section1">
            <div class="left-content">
                ...
                <p>Put sustainability on the menu and you can visibly demonstrate your engagement for a food future that respects the health of the planet and their communities. With conscious choices you will win customers and employees over. By carefully picking the products you use, you can create a positive impact on the environment as well as the health of your customers. Just think about more regional, more organic, less sugar, less salt.<span id="dots"></span>
...
<span class="icon-list">
    ...
    <button class="modal-togg">Flexitarian</button>
        ...
        <div class="section-simple-way text-center">
            ...
            <p>As restaurateur there are many ways how to make your menu sustainable. But as individual communities have different ideas of whatconstitutesa sustainable plate, you can tailor the following steps according to yourlocation and customers.</p>
                            </div>
                            </section>
                            <section class="section-slider1 section-slider2">
        <div class="section-slider-center text-center">
            <div class="wrap">  
<div class="slider2">
<div class="item">
...
better meat</button>
        ...
        <section class="section-text-withimages section4-4 more-text">
            <div class="left-content">
...
Fortunately, there are many solutions that you can choose to include conscious proteins into your sustainable menu. When you choose a conscious protein approach you will have a key element of your sustainable menu established and you will create a positive impact on the health of our planet.
                ...
                <button class="read-more-btn"   onclick="myFunction1()" id="myBtn1">Read more</button>
            </div>
            <div class="right-content">
        ...
        <ul class="grid--what">
                    ...
                    <div class="grid--content more-text">
                        ...
                        <h5>What do we need <br> protein for?</h5>
                        ...
                        <button class="read-more-btn"   onclick="myFunction2()" id="myBtn2">Read more</button>
                            </div>
                    </li>
                    <li>
                        ...
                        <button class="read-more-btn"   onclick="myFunction3()" id="myBtn3">Read more</button>
                            </div>
                    </li>
                    <li>
                    <div class="grid--content more-text">
...
In recent history René Redzepi of Noma  in Denmark popularised the concept and since then several chefs around the world have started foraging. While still niche, the foraging chefs have a strong connection to their communities for example Aidan Brookes of eleven98 in London. They raise awareness of eating sustainably, slowly building a wave towards a greater respect of the local environment and the need to look after their communities. Be inspired by chefs such as Ana Ros of Hisa Franko in Slovenia, Prateek Sadhu of Masque in India, HisotoNakahigashi of Miyamasou in Japan, Wojciech Modest Amaro of Atelier Amaro in Poland and Ricky Saward of Seven Swans Must Die in Germany.
                        ...
                        <button class="read-more-btn"   onclick="myFunction4()" id="myBtn4">Read more</button>
                            </div> 
                    </li>
                            </ul>
        ...
        <section class="section-highlight-withimages  section4-5">
            ...
            <ul>
                    <li>
                        ...
                        <p>Use your menu as an opportunity to show what you are doing as a restaurant  to be more sustainable for example 
                            <span id="more5">the way you manage food waste, food donations,involvement in your community. Invite customers to take food that they have not eaten, home with them. In sustainable packaging of course!</span></p>
                    ...
                    <div class="circle-content more-text">
                        ...
                        <div class="more-text"><p>Consider that many consumers are used to choosing on the basis of taste and price. Sustainable ingredients often </p>
...
(house made casserole with mixed organic beans, organic tomato and smokedpimento. Served with a side of wild rice. A delicious and filling protein fix!)
        ...
        <section class="section-lena-kitchen container">
...
choose a suitable meal!</p>
                    ...
                    <div class="collapsible__header">TO GO</div>
                        <p class="collapsible__content">If you can't make it to Lena's kitchen yourself or are In a rush to go elsewhere, we have a delivery and takeaway service. Our containers are compostable at home. Soon we will offer a container deposit scheme so you can save even more packaging going to the rubbish bin! <br> Watch this space.. </p>
                    </li>
                            </ul>
                            </section>
        <section class="section-text-withimages  section4-5">
            <div class="left-content">
            ...
            <div class="bottom-left">
                <div class="top-content5">
                    ...
                    <p>METRO offers the digital tool PROTRACE where you can find out about both the product itself and the supply routes from its origin to the journey to METRO. </p>
                     <p><strong>Applications that can support with menu design or communcations are:</strong></p>
                </div>
                ...
                <div class="top-content5">
                    <h3>METRO  Offer</h3>
                    <p>METRO has useful supporting tools available  to support you in your MSR journey</p>
                </div>
                <div class="bottom-content5">
                <ul>
                    <li>
...
your staff
          ...
          <p>Involve your staff at the beginning. Explain what you want to do and why. </p>
        </div>
      </div>
    </div>
  </div>
...
better meat
          ...
          <p>If meat is the main feature of most of your dishes, you can reducethe portion of meat, poultry and fish. When you choose meat, poultry, pork and so on look for sustainably sourced products. You can also include different parts of meat that are usually not used, in other words “nose to tail” eating.                              

          </p>
          <div class="listing-use" id="more13">
            <ul>
              <li>
                <h5> 	Use sustainable fish</h5>
                <p>
                Feature fish that is caught responsibly e.g. certified and fully traceable. Introduce uncommon species including those that are usually wasted or ‘by-catch’.
                </p>
              </li>
              <li>
                <h5> 	Celebrate vegetables </h5>
                <p>
                Introduce (more) dishes that feature vegetables as the main or only ingredient and increase the amount of whole vegetables on a plate compared to the meator fish portion.
                </p>
              </li>
              <li>
                <h5>  	Experiment with plant proteins </h5>
                <p>
                Use (more) whole plant proteinsfor example lentils, quinoa, teff, beans,and seaweed. You can also introduce different processed plant proteinsfor example tofu and tempeh.
                </p>
              </li>
              <li>
                <h5> 	Introduce diverse grains</h5>
                <p>
                Use ancient varieties of grains such asteff or those that are common to yourregion.
                </p>
              </li>
              <li>
                <h5> 	Avoid highly processed ingredients</h5>
                <p>
                Be mindful of imitations of traditionalingredients. Often, these are highlyprocessed,high in sugar, salt, transfatsand are not particularly healthy.
                </p>
              </li>
              <li>
                <h5>  	Introduce inclusive dishes</h5>
                <p>
                Offer dishes that accommodatedifferent dietary preferences, for example a vegan option.
                </p>
              </li>
            </ul>
          </div>
