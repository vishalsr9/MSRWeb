...
<select>
<option value="übersicht-meine-nachhaltige-speisekarte.php" selected>DEU</option>
...
<div class="container-full">
    <div class="page-3_stage">
        ...
        <section class="section4">
            <div class="left-content">
                <h3><a href="tipps-für-meine-nachhaltige-speisekarte.php" target="_self">MIT EINFACHEN SCHRITTEN ZUR NACHHALTIGEN SPEISEKARTE </a></h3>
                ...
                <li>Vermeiden Sie stark verarbeitete Zutaten<br>(Diese haben mehrere Verarbeitungsschritte durchlaufen und enthalten viele Zutaten und Zusatzstoffe)</li>
                 ...
                 <div class="read-wrap">
                <a href="tipps-für-meine-nachhaltige-speisekarte.php" class="read-more" target="_self">Weiterlesen</a>
                </div>
            </div>
            <div class="right-content">
