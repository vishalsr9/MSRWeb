...
<header>
    <div class="container  no-print">
        <div class="logo">
        <a href="home.php">  <img src="images/metro-logo.svg" /></a>
        </div>
...
<select>
  <option value="tipps-für-meine-nachhaltige-speisekarte.php" selected>DEU</option>
  <option value="explore-sustainable-menu.php">ENG</option>
</select>
</div>
        </div>
    </div>
    ...
    <div class="modal-wrapper1 modal-transition1">
      ...
      <div class="modal-body1">
        ...
        Leiten Sie Ihre Mitarbeitenden im Service entsprechend an
          ...
          <p>Ihre Servicekräfte sind von grundlegender Bedeutung für die Kommunikation Ihrer 
 Philosophie. Wenn Sie Ihr Team in Ihre Entscheidungsprozesse einbinden, werden alle 
umso überzeugender agieren. 
</p>
        </div>
      </div>
    </div>
