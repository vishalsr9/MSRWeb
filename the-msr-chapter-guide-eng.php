...
<body class="page2-page">
		...
		<div class="container">
			...
			<div class="header-menu">
						...
						<li class="menu-click" onclick="openNav()">
							...
							<div id="myNav" class="overlay-menu">
								...
								<div class="overlay-content">
									...
									<a href="javascript:void(0)" class="btn-changing">My Sustainable Restaurant</a>
				...
				<div class="custom__select">
					<select>
						<option value="the-msr-chapter-guide-deu.php">DEU</option>
						<option value="the-msr-chapter-guide-eng.php" selected>ENG</option>
					</select>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="page-2_stage">
			...
			<img src="images/updated-menu-l2.svg" usemap="#image-map" title="L1">
