...
<body class="page3-page">
    ...
    <section class="banner-section">
        <div class="container-full">
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    <img src="images/food_waste/banner-image.svg" class="px-4 img-fluid banner-image" />
                </div>
    ...
    <div class="page-3_stage">
            ...
            <div class="mid-content">
                <ul>
                    <li class="text-center">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <img src="images/food_waste/diduknow-1.svg" class="img-fluid didu-img" />
                            </div>
                            <div class="col-md-12 text-center">
                                <p>
                                    <span class="nowrap1">
                    ...
                    <li class="text-center">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <img src="images/food_waste/diduknow-2.svg" class="img-fluid didu-img w-34rem" />
                            </div>
                            <div class="col-md-12 text-center">
                                <p>
                                    <span class="nowrap1">
                    ...
                    <li class="text-center">
                        <img src="images/food_waste/diduknow-3.svg" class="img-fluid didu-img w-25rem" />
                        <p>
                            <span class="nowrap1">
                                an area larger than China and
                            </span><br>
                            <span class="nowrap1">
                                <span class="highlight">1/4</span> of the world’s fresh water supply
                            </span><br>
                            <span class="nowrap1">
                                is used to grow food that is never eaten
                            </span>
                        </p>
                    </li>
                    <li class="text-center">
                        <img src="images/food_waste/diduknow-4.svg" class="img-fluid didu-img h288px" />
                        <p>
                            <span class="nowrap1">
                                <span class="highlight">36%</span> of HoReCa customers (globally)
                            </span><br>
                            <span class="nowrap1">
                                think that reducing food waste
                            </span><br>
                            <span class="nowrap1">
                                is one of the most important issues to deal
                            </span>
                            <span class="nowrap1">
        ...
        <section class="section3">
            <div class="section3-inner align-normal">
                ...
                <div class="right-content">
                    <p>
                        Food waste costs you and your customers money. Throwing away
                        valuable resources uneaten also holds enormous potential for
                        environmental and social conflict which young and future customers
                        are not willing to accept. Did you know that if food waste was a
                        country, it would be the 3rd largest emitter of greenhouse gases?
            ...
            <div class="section3-inner3 align-normal">
                ...
                <div class="right-content">
                    <p>
                        The demand for food is increasing as the world ́s population grows,
                        but farmland is finite. That ́s why preventing food waste is an
                        important issue in terms of global food security. Every year, over 1/3
                        of all food produced globally goes to waste while <span class="highlight">840 million people are going hungry to bed</span>
                        . Each one of them could be sufficiently fed
                        with less than what is wasted in the US, UK and Europe every year.
                        According to a global METRO study from 2019, 39% of METRO’s
                        HoReCa customers want to tackle food waste in their own operations.
                    </p>
                </div>
            </div>
        </section>
        <section class="section4">
            ...
            <div class="container-full">
                <div class="row">
                    <div class="col-md-6 mt-2 mb-2 px-5 b-right">
                        <h3 class="h3v">KNOW HOW –<br>KNOW HOW –

                            STEPS HOW TO

                            AVOID FOOD WASTE</h3>
                        <p class="theme-p">
                            Avoid food waste by identifying the types of waste and
                            where it is generated. Food waste comes from either
                            the back of house i.e. in the kitchen before serving or
                            from the front of the house i.e. where customers are
                            served. Fruit and vegetables, for example, are a major
                            contributor to food waste in a restaurant. Learn how to
                            store them well to avoid waste. Talk with your staff and
                            help them understand the importance of reducing
                            waste. Discount or donate surplus food to help people
                            and animals in need. Practice advanced ways to reduce
                            food waste, e.g. compost food waste at your restaurant
                            or through a local service and learn to cook with
                            unwanted parts. Technical solutions can also improve
                            operational efficiency and reduce food waste e.g. by
                            managing the food waste inventory and redistribution
                            of food online, thereby eliminating time for waste
                            management. You can find out more about food waste
                            reduction in our latest Food Waste Report.
                        </p>

                        <p class="theme-p">
                            Landfills should be the last place where food waste
                            ends up!
                        </p>

                        <div class="read-wrap">
                            <a href="explore-food-waste.php" class="read-more">Read More</a>
                        </div>
                    </div>
                    <div class="col-md-6 mt-2 mb-2 just-center">
                        <img src="images/food_waste/hierarchy9.svg" class="img-fluid heirarchy-image mx-auto my-auto" />
                    </div>
                </div>
            </div>
