      ...
      <div class="row px-4 no-print">
        ...
        <div class="col-md-5 offset-md-1 no-print">
          <div class="banner_l4_img">
            <img src="./images/safe_food/Asset 1.svg" class="img-fluid pl-5" style="width:80%;float:right;">
          </div>
        </div>
      </div>
    </div>
...
">Die Reduzierung von Lebensmittelabfällen hat viele Vorteile</h4>
  ...
  <style>
    ...
    .thermo-fruits {
      column-count: 2;
      /* column-gap: 0rem; */
      list-style-image: url("images/food_waste/bull.svg");
      font-size: 20px;
            ...
            <div class="thermometer-inner">
              <div class="thm-inner-sec-1">
                <div class="sec-1-content">
                  ...
                  <span class="iarrow1">
                    <img src="images/food_waste/c-arrow.svg" class="img-fluid i1r">
                  </span>
                </div>
              </div>
  ...
  <script>
    ...
    function starter() {
      var lcook = getCookie("likedCook3d");
      var dlcook = getCookie("dislikedCook3d");
      if (lcook) {
        $(".cy").addClass("cyliked");
    ...
    function liked() {
      var lcook = getCookie("likedCook3d");
      if (lcook) {
        eraseCookie("likedCook3d");

      } else {
        setCookie("likedCook3d", "1", 365);

      }
      eraseCookie("dislikedCook3d");
      starter();
    };
    ...
    function disliked() {
      ...
      if (dlcook) {
        ...
        setCookie("dislikedCook3d", "1", 365);
      }
      eraseCookie("likedCook3d");
      starter();
    };
      ...
      <div class="row mt-4">
        <div class="col-md-6">
          ...
          <ul>
            ...
            <li>Lebensmittelabfälle im <a href="https://www.mpulse.de/de/warenbewegen/nose-to-tail-vergessene-delikatessen-erobern-die-restaurants" target="_blank"> vorderen Bereich des</a> Restaurants.
            </li>
