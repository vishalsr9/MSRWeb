...
<body class="page4-page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-4 mx-0 icon-box-1">
                            <div class="icon-box-1-content">
                                ...
                                <div class="text-holder">
                                    Sie erhöhen die Nachfrage nach nachhaltigen Produkten und ermutigen Ihre Lieferanten, ihre eigenen nachhaltigen Maßnahmen zu entwickeln und zu verbessern.
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="swiper-slide ss sl9 sl99">
                                                    <div class="row swiper-slide-inner">
                                                        <div class="col px-1 py-1 mt-1 mb-1 slimage slimage99">
                                                            <img src="images/resp_sourcing/scheme-logos/Roundtable on Sustainable Palm Oil.png" class="img-fluid mt-2" style="width:6rem!important;">
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-2 mt-2">
                                                    <p class="justify1">
                                                        ...
                                                        Tierwohl ist eine Bezeichnung für die Gesundheit und das Wohlbefinden von Tieren, insbesondere von Nutztieren. Das Tierwohl umfasst die Aspekte körperliche Gesundheit, die Ausführbarkeit von natürlichen Verhaltensweisen und das emotionale Wohlbefinden der Tiere.
    ...
    <script>
        ...
        function starter() {
            var lcook = getCookie("likedCook2d");
            var dlcook = getCookie("dislikedCook2d");
            if (lcook) {
                $(".cy").addClass("cyliked");
        ...
        function liked() {
            var lcook = getCookie("likedCook2d");
            if (lcook) {
                eraseCookie("likedCook2d");

            } else {
                setCookie("likedCook2d", "1", 365);

            }
            eraseCookie("dislikedCook2d");
            starter();
        };
        ...
        function disliked() {
            ...
            if (dlcook) {
                ...
                setCookie("dislikedCook2d", "1", 365);
            }
            eraseCookie("likedCook2d");
            starter();
        };
