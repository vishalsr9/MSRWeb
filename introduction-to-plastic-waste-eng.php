...
<body class="page3-page">
        ...
        <div class="container">
            ...
            <div class="new_header header-menu">
                ...
                <div class="custom__select top-mar-less">
                    <select>
                        <option value="introduction-to-plastic-waste-deu.php">DEU</option>
                        <option value="introduction-to-plastic-waste-eng.php" selected>ENG</option>
                    </select>
                </div>
                <nav>
                    <ul class="main">
    ...
    <section class="banner-section">
        <div class="container-full">
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    <img src="images/plastic_waste/banner-image.svg" class="mt-5 px-5 img-fluid banner-image" / style="width:63rem;right: 7rem;">
                </div>
    ...
    <div class="page-3_stage">
        ...
        <section class="section2" style="margin-top: 9.6rem;">
                    ...
                    <div class="row">
                        <!-- <div class="col-md-12 mx-auto my-auto border-b">
                            <div class="diduknow-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="images/plastic_waste/strspng.png" class="img-fluid diduknow-img img-w12rem" />
                                    </div>
                                    <div class="col-md-12">
                                        <p class="diduknow-p">
    ...
    height: 13.2rem;" />
                        ...
                        <div class="col-md-6">
                            <div class="diduknow-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="images/plastic_waste/earth-happy.svg" class="img-fluid diduknow-img img-w15rem mt-5" />
                                    </div>
                                    <div class="col-md-12">
                                        <p class="diduknow-p">
        ...
        <div class="container-full">
            <div class="row">
                <div class="col-md-7 mt-2 mb-2 px-5 b-right">
                    <h3 class="h3v3 text-black">Know How –<br>Steps How To Minimize<br>
    ...
    <section class="section5">
        <div class="bottom-left">
            <div class="top-content5">
                ...
                <p>METRO offers a wide variety of waste-less products, such as eco-friendly disposables and takeaway containers, products with less packaging e.g. reformulated detergents, returnable drinks bottle schemes, water filters, reusable carafes for water, products that don´t contain PVC or are alternatives for EPS.</p>
