...
<body class="stage1">
    ...
    <div class="container">
      ...
      <div class="new_header header-menu">
        ...
        <div class="custom__select top-mar-less">
          <select>
            <option value="explore-waste-deu.php">DEU</option>
            <option value="explore-waste-eng.php" selected>ENG</option>
          </select>
        </div>
        <nav>
          <ul class="main">
  ...
  <div class="container-full">
    <div class="page-3_stage page-4_stage plastic_waste_l4_page">
      ...
      <section class="good_to_know no-print mtcsutom energy_page waste_l4-page">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 px-4">
              ...
              <div class="good_to_know_box p-4 safe_foodBox_l4">
                <img src="./images/safe_food/wl5.svg" class="img-fluid">
            ...
            <div class="col-md-4 px-4">
              <div class="good_to_know_box p-4 safe_foodBox_l4">
                <img src="./images/safe_food/wl4.svg" class="img-fluid">
              ...
              <div class="good_to_know_box p-4 safe_foodBox_l4">
                <img src="./images/safe_food/wl7.svg" class="img-fluid">
      ...
      <section class="simple_wayTo_preventing no-print waste_l4_energy_page_slider">
                                    ...
                                    <div class="swiper-slide pageSlider-slide text-center">
                                      <div class="row">
                                        ...
                                        <div class="col-md-12">
                                          <div class="pageSlider-slide-button">
                                            <span class="sldBtn06">
                                              <a href="introduction-to-plastic-waste-eng.php" target="_blank" class="read-more-btn">Read more</a>
                                            </span>
                                          </div>
                                        </div>
                                      </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="plastic-wasteStepImg">
              <img src="./images/plastic-waste/Asset 19.svg">
            </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="img-holder2">
                <div class="img-holder2-inner">
                  <img src="./images/safe_food/Asset 44.svg" class="tntImg">
                </div>
              </div>
      ...
      <script>
        ...
        function starter() {
          var lcook = getCookie("likedCook8e");
          var dlcook = getCookie("dislikedCook8e");
          if (lcook) {
            $(".cy").addClass("cyliked");
        ...
        function liked() {
          var lcook = getCookie("likedCook8e");
          if (lcook) {
            eraseCookie("likedCook8e");

          } else {
            setCookie("likedCook8e", "1", 365);

          }
          eraseCookie("dislikedCook8e");
          starter();
        };
        ...
        function disliked() {
          ...
          if (dlcook) {
            ...
            setCookie("dislikedCook8e", "1", 365);
          }
          eraseCookie("likedCook8e");
          starter();
        };
