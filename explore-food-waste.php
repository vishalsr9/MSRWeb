        ...
        <div class="container no-print">
            ...
            <div class="header-menu">
                ...
                <div class="custom__select">
                    <select>
                        <option value="tipps-für-meine-nachhaltige-speisekarte.php">DEU</option>
                        <option value="explore-sustainable-menu.php" selected>ENG</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="page-3_stage page-4_stage">
            ...
            <section class="section2">
                <div class="text-center">
                    <div class="wrap-2">
                        <h3 class="section-heading-blue">Landfills should be the last place for food waste</h3>
                        <p>
                            Over 1/3 of all food produced globally goes to waste. There are many other ways to handle food waste.

                            First of all: think about how you can avoid food waste. Then resell surplus food, donate it to people in need, or animal
                            shelters. If possible, recycle food for other purposes and compost as much as possible. Ensure you minimize the

                            quantity of food waste that goes to landfills.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row" style="margin-bottom: 100px;">
                        <div class="col-md-12 mt-2 mb-2">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12 mt-4 mx-0 icon-box-1">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12 mt-4 mb-4 mx-0">
                                            <div class="icon-box-9">
                                                <p>
                                                    Benefits
                                                    of reducing
                                                    food waste
                                        ...
                                        <div class="col-md-12 mt-4 mx-0 icon-box-1">
                                            <div class="icon-box-1-content">
                                                ...
                                                <div class="text-holder">
                                                    ...
                                                    by standing out as responsible
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 mt-2 mb-2 text-center">
                            <h3 class="h3v2">Good to Know</h3>
                            <p class="theme-p text-bold">
                                Optimum “short-term” storage temperature ranges (°C)
                            </p>

                            <img src="images/food_waste/thermometer.svg" class="img-fluid thermometer mb-2 mt-2">
                            <img src="images/food_waste/thermometer-controls.svg" class="img-fluid thermometer mb-2 mt-2">
                        </div>
                    </div>
                </div>
