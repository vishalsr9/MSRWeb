    ...
    <div class="container-full">
        <div class="page-3_stage page-4_stage">
            ...
            <script>
                ...
                function starter() {
                    var lcook = getCookie("likedCook7e");
                    var dlcook = getCookie("dislikedCook7e");
                    if (lcook) {
                        $(".cy").addClass("cyliked");
                ...
                function liked() {
                    var lcook = getCookie("likedCook7e");
                    if (lcook) {
                        eraseCookie("likedCook7e");

                    } else {
                        setCookie("likedCook7e", "1", 365);

                    }
                    eraseCookie("dislikedCook7e");
                    starter();
                };
                ...
                function disliked() {
                    ...
                    if (dlcook) {
                        ...
                        setCookie("dislikedCook7e", "1", 365);
                    }
                    eraseCookie("likedCook7e");
                    starter();
                };
