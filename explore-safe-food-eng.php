...
<body class="page4-page">
    ...
    <div class="container-full">
        ...
        <div class="page-3_stage page-4_stage">
            ...
            <section class="soFood_importants">
                <div class="container-fluid px-5">
                    <div class="row bg_yellow ">
                        <h4>Why safe food is so important</h4>
                        <div class="col-md-4 px-4">
                            <div class="import_box">
                                <img src="./images/safe_food/Asset 32.png" class="img-fluid">
                        ...
                        <div class="col-md-4 px-4">
                            <div class="import_box">
                                <img src="./images/safe_food/Asset 34.png" class="img-fluid">
                        ...
                        <div class="col-md-4 px-4">
                            <div class="import_box">
                                <img src="./images/safe_food/Asset 33.png" class="img-fluid">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-4">
                                ...
                                <p>Good quality products were the second most
                                    important consideration for HoReCa customers
                                    globally, according to METRO’s sustainability survey
                                    2019. </p>
                            </div>
                        </div>
            ...
            <section class="three-step_food_safety">
                <div class="container-fluid px-4">
                    <div class="row">
                        <h3>Three steps to food safety</h3>
                        <div class="col-md-6">
                            <div class="step_safty_para">
                                <p>Safe food is the foundation of a sustainable restaurant. Keeping food safe doesn’t have to be complicated although there are different levels to which your business can operate. The first step is to have a food safety management system. On top of this is HACCP (Hazard Analysis Critical Control Points) which is a legal </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="step_safty_para">
                                <p>requirement in many, but not all countries. To make these systems effective, we recommend a food safety culture, which means shared values and commitment of your leadership to ensuring safe food. Check out the following information for a robust framework for safe food: </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="test">
                            <div class="tab-container-one">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="col-md-4 nav-item active"><a class="nav-link active" href="#home" role="tab" aria-controls="home" data-bs-toggle="tab">Food Safety Management System (FSMS)</a></li>
                                    <li class="col-md-4 nav-item"><a class="nav-link" href="#profile" role="tab" aria-controls="profile" data-bs-toggle="tab">7 principles of HACCP </a></li>
                                    <li class="col-md-4 nav-item"><a class="nav-link" href="#messages" role="tab" aria-controls="messages" data-bs-toggle="tab">Food Safety Culture </a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 offset-md-1">
                                                <div class="three-step_para">
                                                    ...
                                                    <p>If you do the following activities to manage food safety, you will also be implementing sustainability:</p>
                                                                    ...
                                                                    <div class="swiper-slide sl-box">
                                                                        <div class="slide-inner">
                                                                            ...
                                                                            <div class="sl-button sl-button-5 text-center">
                                                                                <button class="read-more-btn r5" id="sl-button sl-button-5">Read more</button>
                                                                            </div>
                                        ...
                                        <p class="text-center nextStepCta mt-4"><a href="javascript:void(0);">Next Step <i class="fa fa-long-arrow-right"></i></a></p>
                                    ...
                                    <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 offset-md-1">
                                                <div class="three-step_para">
                                                    <p><strong>HACCP (Hazard Analysis and Critical Control Points)</strong> is a methodology that can guide your restaurant towards better food safety practices. In some countries, for example in Europe, it is already a legal requirement but generally restaurants are not expected to have a fully comprehensive HACCP system. It is based around seven basic principles of mitigating risk and preventing adverse outcomes. By being aware of what could go wrong, you and your staff can manage your business in a way to prevent things going wrong and have a way to deal with it if something does happen. This risk-based approach can also help you manage sustainability hazards for example preventing used cooking oil from leaking into the drain system instead of collecting it separately as required. HACCP indicates you to identify, evaluate and control all food hazards.</p>
                                                    <p class="mt-4"><strong>The seven main principles are:</strong></p>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="swiper-wrapper swx-wrapper">
                                                                    ...
                                                                    <div class="swiper-slide sl-box">
                                                                        <div class="slide-inner">
                                                                            ...
                                                                            <div class="sl-text sl-text-2 text-center">
                                                                                <span class="sltext-holder">
                                                                                    2. Identify the critical<br>control points (CCPs)<br>                                                                                </span>
                                                                            </div>
                                                                            <div class="sl-button sl-button-2 text-center">
                                                                                <button class="read-more-btn r2" id="sl-button sl-button-2">Read more</button>
                                                                            </div>
                                                                    ...
                                                                    <div class="swiper-slide sl-box">
                                                                        <div class="slide-inner">
                                                                            ...
                                                                            <div class="sl-image sl-image-6 text-center sl-images_6">
                                                                                <span class="slimg-holder">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 offset-md-1">
                                                <div class="three-step_para">
                                                    ...
                                                    <p class="mt-4"><strong>Check out the following simple steps to create a food safety culture:</strong></p>
                                                </div>
                                            </div>
                                        </div>
