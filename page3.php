...
<select>
  <option value="gr-page3.php">DEU</option>
  <option value="page3.php" selected>ENG</option>
</select>
</div>
            </div>
        </div>
        ...
        <div class="page-3_stage">
            ...
            <div class="section3-grid">
                <ul>
                    <li><p>Benefits</p></li>
                    <li></li>
                    <li><p>Easily changeable with the season</p></li>
                    <li></li>
                    <li><p>Save costs with plant  based dishes</p></li>
                    <li></li>
                                <!-- </ul>
                <ul> -->
                    <li></li>
                    <li><p>Increase profit with better meat</p></li>
                    <li></li>
                    <li><p>Stand out from the competition</p></li>
                    <li></li>
                    <li><p>Keep up with social trends</p></li>
                                <!-- </ul>
                <ul> -->
                    <li><p>Cater to new costumers</p></li>
                    <li></li>
                    <li><p>Stable, profitable business</p></li>
                    <li></li>
                    <li><p>Revive the local economy</p></li>
                    <li></li>
                                <!-- </ul>
                <ul> -->
                    <li></li>
                    <li><p>Varied and delicious dishes</p></li>
                    <li></li>
                    <li><p>Positive, restorative impact on local community and global environment</p></li>
                    <li></li>
                    <li><p></p></li>
                                </ul>
            </div>
            ...
            <section class="section4">
                <div class="left-content">
                    <h3><a href="page4.php" target="_self">Know how – <br> Steps how to create a <br> Sustainable Menu</a></h3>
...
There are several steps that can help you.
                    ...
                    <li>Using more plant proteins to meet the interests of <br> your customer</li>
                     ...
                     <div class="read-wrap">
                    <a href="page4.php" class="read-more" target="_self">Read More</a>
                    </div>
                </div>
                <div class="right-content">
