    ...
    <div class="page-3_stage page-4_stage plastic_waste_l4_page">
      ...
      <section class="section1 no-print plastic_waste no-print">
        ...
        <div class="right-content no-print">
          <img src="./images/plastic-waste/Asset 1.svg">
        </div>
      </section>
      ...
      <section class="howTopreventPlastic no-print bg_blue1">
        <div class="container-fluid no-print">
          <div class="bg_blue px-5">
            <div class="row no-print">
              ...
              <div class="col-md-3">
                <img src="./images/plastic-waste/Asset 3.svg" class="no_banimg">
              </div>
            </div>
      ...
      <section class="plastic-waste_goodToKnow no-print">
        <div class="container">
          <div class="row">
          ...
          <div class="row" style="margin-top: 70px;">
            ...
            <div class="col-md-6">
              <div class="plastic-waste_goodToKnow_box">
                <img src="./images/plastic-waste/Asset 17.svg" style="width: 45%;">
      ...
      <section class="simple_wayTo_preventing no-print">
                                  ...
                                  <div class="swiper-slide pageSlider-slide text-center">
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="pageSlider-slide-image">
                                          <span class="sldImg04">
                                            <img src="images/safe_food/pw-4.svg" class=" img-fluid german_img">
                                          </span>
                                        </div>
                                      </div>
                                      <div class="col-md-12">
                                  ...
                                  <div class="swiper-slide pageSlider-slide text-center">
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="pageSlider-slide-image">
                                          <span class="sldImg08">
                                            <img src="images/safe_food/pw-8.svg" class=" img-fluid german_img2">
                                          </span>
                                        </div>
                                      </div>
                                      <div class="col-md-12">
      ...
      <script>
        ...
        function starter() {
          var lcook = getCookie("likedCook4d");
          var dlcook = getCookie("dislikedCook4d");
          if (lcook) {
            $(".cy").addClass("cyliked");
        ...
        function liked() {
          var lcook = getCookie("likedCook4d");
          if (lcook) {
            eraseCookie("likedCook4d");

          } else {
            setCookie("likedCook4d", "1", 365);

          }
          eraseCookie("dislikedCook4d");
          starter();
        };
        ...
        function disliked() {
          ...
          if (dlcook) {
            ...
            setCookie("dislikedCook4d", "1", 365);
          }
          eraseCookie("likedCook4d");
          starter();
        };
      ...
      <section class="section5">
        ...
        <div class="bottom-right">
          <div class="top-content5">
            ...
            <p>METRO unterstützt Sie mit vielen nachhaltigen Produkten bei Ihrer Nachhaltigkeitsstrategie:
