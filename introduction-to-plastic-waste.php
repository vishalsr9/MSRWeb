    ...
    <section class="banner-section">
        <div class="container-full">
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    <img src="images/plastic_waste/banner-image.svg" class="mt-5 px-5 img-fluid banner-image" />
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mx-auto my-auto border-b">
                            <div class="diduknow-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-danger">
                                            [IMAGE LOW RESOLUTION EXPORT ISSUE]
                                        </p>
                                    </div>
                                    <div class="col-md-12">
                                        <p class="diduknow-p">
                        ...
                        <div class="col-md-6 border-r border-b">
                            <div class="diduknow-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="images/plastic_waste/plastic-bin.svg" class="img-fluid diduknow-img img-w12rem" />
                                    </div>
                                    <div class="col-md-12">
                                        <p class="diduknow-p">
                                            many single-use plastic items have been banned in the EU as of 2021
                        ...
                        <div class="col-md-6 border-b">
                            <div class="diduknow-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="images/plastic_waste/plastic-and-packets.svg" class="img-fluid diduknow-img img-w23rem" />
                                    </div>
                                    <div class="col-md-12">
                                        <p class="diduknow-p">
                                            many single-use plastic items have been banned in the EU as of 2021
                        ...
                        <div class="col-md-6 border-r border-b">
                            <div class="diduknow-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="images/plastic_waste/garbage-1.svg" class="img-fluid diduknow-img img-w27rem" />
                                    </div>
                                    <div class="col-md-12">
                                        <p class="diduknow-p">
                                            many single-use plastic items have been banned in the EU as of 2021
                        ...
                        <div class="col-md-6">
                            <div class="diduknow-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <img src="images/plastic_waste/earth-happy.svg" class="img-fluid diduknow-img img-w15rem" />
                                    </div>
                                    <div class="col-md-12">
                                        <p class="diduknow-p">
                                            many single-use plastic items have been banned in the EU as of 2021
        ...
        <div class="container-full">
            <div class="row">
                <div class="col-md-7 mt-2 mb-2 px-5 b-right">
                    <h3 class="h3v">KNOW HOW –<br>STEPS HOW TO MINIMISE

                        PLASTIC WASTE</h3>
                    <p class="theme-p">
                        Analyse your plastic consumption and the sources of plastic, how you use
                        and dispose it. A simple waste audit will help avoid single-use plastic such
                        as plastic-wrapped food and drink or plastic containers for takeaway.
                        Since July 2021, many single-use plastic items have been banned in the EU
                        and further laws will be introduced. In Germany, starting in 2023, caterers,
                        delivery services and restaurants will be required to offer reusable
                        containers for takeaway food and beverages in addition to disposable
                        containers. You too will have to use alternatives that are reusable,
                        recyclable and compostable such as plates made from plant-based
                        materials like bamboo. And you can then go for more advanced ways to
                        avoid plastic waste.
                    </p>

                    <ul class="text-bold-16p">
                        <li>
                            Engage your staff and customers to bring about sustainable change
                        </li>
                        <li>
                            Communicate the necessity and the benefit of using less of the most
                            problematic plastics and publicise what you are doing
                        </li>
                    </ul>

                    <div class="read-wrap">
                        <a href="explore-plastic-waste.php" class="read-more">Read More</a>
                    </div>
                </div>
                <div class="col-md-5 mt-2 mb-2 just-center">
                    <img src="images/plastic_waste/earth-recycle.svg" class="img-fluid heirarchy-image mx-3 my-auto" />
                </div>
            </div>
        </div>
