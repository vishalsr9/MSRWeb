                  ...
                  <div class="section-div">
                          <div class="container-fluid">
                            ...
                            <div class="sw-holder">
                              ...
                              <div class="swholder1">
                                <div class="swholder-sw food_wasteSlide energy_l4">
                                    ...
                                    <div class="swiper-wrapper swx-wrapper" style="cursor: grab; transition-duration: 0ms; transform: translate3d(-71.5px, 0px, 0px);" id="swiper-wrapper-9329353e60f736c3" aria-live="polite">
                                      <div class="swiper-slide sl-box swiper-slide-prev" role="group" aria-label="1 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-1 energy_slider1 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e1.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-1 text-center">
                                            <span class="sltext-holder"> TURN OFF UNNECESSARY<br>LIGHTS AND ELECTRIC EQUIPMENT </span>
                                          </div>
                                      ...
                                      <div class="swiper-slide sl-box swiper-slide-active" role="group" aria-label="2 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-2 energy_slider2 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e2.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-2 text-center">
                                            <span class="sltext-holder">SET A STARTING POINT<br>AND MAKE AN ACTION PLAN  </span>
                                          </div>
                                      ...
                                      <div class="swiper-slide sl-box swiper-slide-next" role="group" aria-label="3 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-3 energy_slider3 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e3.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-3 text-center">
                                            <span class="sltext-holder">CONTACT<br>YOUR UTILITY COMPANY</span>
                                          </div>
                                      ...
                                      <div class="swiper-slide sl-box" role="group" aria-label="4 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-4 energy_slider4 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e4.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-4 text-center">
                                            <span class="sltext-holder"> PAY ATTENTION TO<br>YOUR COOLING EQUIPMENT </span>
                                          </div>
                                      ...
                                      <div class="swiper-slide sl-box" role="group" aria-label="5 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-5 energy_slider5 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e5.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-5 text-center">
                                            <span class="sltext-holder"> CHECK<br>YOUR REFRIGERATOR </span>
                                          </div>
                                      ...
                                      <div class="swiper-slide sl-box" role="group" aria-label="5 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-5 energy_slider6 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e6.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-5 text-center">
                                            <span class="sltext-holder"> DON’T WASTE ICE </span>
                                          </div>
                                          <div class="sl-button sl-button-5 text-center">
                                      ...
                                      <div class="swiper-slide sl-box" role="group" aria-label="5 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-5 energy_slider7 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e7.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-5 text-center">
                                            <span class="sltext-holder"> CHANGE YOUR LIGHTS FOR<br>ENERGY-EFFICIENT ONES </span>
                                          </div>
                                          <div class="sl-button sl-button-5 text-center">
                                      ...
                                      <div class="swiper-slide sl-box" role="group" aria-label="5 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-5 energy_slider8 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e8.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-5 text-center">
                                            <span class="sltext-holder"> CLEAN AND MAINTAIN<br>YOUR EQUIPMENT </span>
                                          </div>
                                          <div class="sl-button sl-button-5 text-center">
                                      ...
                                      <div class="swiper-slide sl-box" role="group" aria-label="5 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-5 energy_slider9 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e9.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-5 text-center">
                                            <span class="sltext-holder"> DECREASE HEAT USAGE </span>
                                          </div>
                                          <div class="sl-button sl-button-5 text-center">
                                      ...
                                      <div class="swiper-slide sl-box" role="group" aria-label="5 / 5">
                                        <div class="slide-inner">
                                          <div class="sl-image sl-image-5 energy_slider10 text-center">
                                            <span class="slimg-holder">
                                              <img src="./images/safe_food/e10.svg" class="img-fluid mb-2 mt-2">
                                            </span>
                                          </div>
                                          <div class="sl-text sl-text-5 text-center">
                                            <span class="sltext-holder"> REORGANISE YOUR KITCHEN </span>
                                          </div>
                                          <div class="sl-button sl-button-5 text-center">
...
<section class="no-side-margin no-print">
 ...
 <div id="energy_content1" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close1">X</a>
      </div>
    </div>
     <div id="energy_content2" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close2">X</a>
      </div>
    </div>
     <div id="energy_content3" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close3">X</a>
      </div>
    </div>
     <div id="energy_content4" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close4">X</a>
      </div>
    </div>
     <div id="energy_content5" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close5">X</a>
      </div>
    </div>
     <div id="energy_content6" class="modalx">
      <div class="modalx-content">
        <h4> Don’t waste ice
</h4>
        ...
        <a class="read-more-btn btn btn-sm energy_close6">X</a>
      </div>
    </div>
     <div id="energy_content7" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close7">X</a>
      </div>
    </div>
     <div id="energy_content8" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close8">X</a>
      </div>
    </div>
     <div id="energy_content9" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close9">X</a>
      </div>
    </div>
     <div id="energy_content10" class="modalx">
      <div class="modalx-content">
        ...
        <a class="read-more-btn btn btn-sm energy_close10">X</a>
      </div>
    </div>
