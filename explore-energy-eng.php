    ...
    <div class="container">
      ...
      <div class="new_header header-menu">
        ...
        <div class="custom__select top-mar-less">
          <select>
            <option value="explore-energy-deu.php">DEU</option>
            <option value="explore-energy-eng.php" selected>ENG</option>
          </select>
        </div>
        <nav>
          <ul class="main">
  ...
  <div class="container-full">
    <div class="page-3_stage page-4_stage plastic_waste_l4_page">
      ...
      <script>
        ...
        function starter() {
          var lcook = getCookie("likedCook6e");
          var dlcook = getCookie("dislikedCook6e");
          if (lcook) {
            $(".cy").addClass("cyliked");
        ...
        function liked() {
          var lcook = getCookie("likedCook6e");
          if (lcook) {
            eraseCookie("likedCook6e");

          } else {
            setCookie("likedCook6e", "1", 365);

          }
          eraseCookie("dislikedCook6e");
          starter();
        };
        ...
        function disliked() {
          ...
          if (dlcook) {
            ...
            setCookie("dislikedCook6e", "1", 365);
          }
          eraseCookie("likedCook6e");
          starter();
        };
