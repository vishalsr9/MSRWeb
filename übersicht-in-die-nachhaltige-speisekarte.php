...
<header>
    <div class="container">
        <div class="logo">
        <a href="heim.php"> <img src="images/metro-logo.svg" /></a>
        </div>
...
<select>
<option value="übersicht-in-die-nachhaltige-speisekarte.php" selected>DEU</option>
<option value="introduction-to-sustainable-menu.php">ENG</option>
</select>
</div>
    ...
    <div class="page-3_stage">
        ...
        <div class="section3-grid">
            <ul>
                ...
                <li></li>
                <li><p>Positive Auswirkungen auf die lokale Gemeinschaft und die globale Umwelt
</p></li>
                <li></li>
                <li><p></p></li>
                            </ul>
        ...
        <section class="section4">
            <div class="left-content">
                <h3><a href="tipps-für-nachhaltiges-menü.php" target="_self">MIT EINFACHEN SCHRITTEN ZUR NACHHALTIGEN SPEISEKARTE </a></h3>
                ...
                <li>(Diese haben mehrere Verarbeitungsschritte durchlaufen und enthalten viele Zutaten und Zusatzstoffe)
</li>
                 </ul>
                 ...
                 <div class="read-wrap">
                <a href="tipps-für-nachhaltiges-menü.php" class="read-more" target="_self">Weiterlesen</a>
                </div>
            </div>
            <div class="right-content">
