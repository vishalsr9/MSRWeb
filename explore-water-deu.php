        ...
        <div class="page-3_stage page-4_stage">
            ...
            <section class="section1 no-print">
                ...
                <div class="right-content no-print">
                    <img src="images/water/banner_img.svg" class="img-fluid mt-4 banner-img" />
                </div>
                ...
                <div class="container9 mt-m2 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-2 mt-2">
                            <!---middle row-->
                            <img src="images/water/advance-ways.svg" class="img-fluid px-5" />
                        </div>
                        <div class="col-md-12 mb-2 mt-2">
                            <!---bottom row-->
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="aw-07">
                                            ...
                                            <div class="col-md-12 text9">
                                                ...
                                                <button class="read-text btn-active" id="sevevebtn">Weiterlesen</button>
                                            </div>
            ...
            <script>
                ...
                function starter() {
                    var lcook = getCookie("likedCook7d");
                    var dlcook = getCookie("dislikedCook7d");
                    if (lcook) {
                        $(".cy").addClass("cyliked");
                ...
                function liked() {
                    var lcook = getCookie("likedCook7d");
                    if (lcook) {
                        eraseCookie("likedCook7d");

                    } else {
                        setCookie("likedCook7d", "1", 365);

                    }
                    eraseCookie("dislikedCook7d");
                    starter();
                };
                ...
                function disliked() {
                    ...
                    if (dlcook) {
                        ...
                        setCookie("dislikedCook7d", "1", 365);
                    }
                    eraseCookie("likedCook7d");
                    starter();
                };
            ...
            <section class="section5 no-print">
                <div class="bottom-left">
                    <div class="top-content5">
                        ...
                        <p>METRO bietet "grüne" Geräte in den Märkten an, die wassersparend sind.</p>
