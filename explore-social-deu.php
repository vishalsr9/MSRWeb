    ...
    <div class="container-full">
        <div class="page-3_stage page-4_stage">
            ...
            <script>
                ...
                function starter() {
                    var lcook = getCookie("likedCook9d");
                    var dlcook = getCookie("dislikedCook9d");
                    if (lcook) {
                        $(".cy").addClass("cyliked");
                ...
                function liked() {
                    var lcook = getCookie("likedCook9d");
                    if (lcook) {
                        eraseCookie("likedCook9d");

                    } else {
                        setCookie("likedCook9d", "1", 365);

                    }
                    eraseCookie("dislikedCook9d");
                    starter();
                };
                ...
                function disliked() {
                    ...
                    if (dlcook) {
                        ...
                        setCookie("dislikedCook9d", "1", 365);
                    }
                    eraseCookie("likedCook9d");
                    starter();
                };
                ...
                <div class="section5  section4-6">
                    <div class="bottom-left">
                        <div class="top-content5">
                            ...
                            <p>METRO bietet Ihnen Beratungen durch METRO-Mitarbeitende an. Eine Referenz finden Sie unter METRO Faire Arbeitsbedingungen.</p>
