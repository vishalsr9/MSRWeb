...
<body class="page3-page">
    ...
    <div class="container">
      ...
      <div class="new_header header-menu">
        ...
        <div class="custom__select top-mar-less">
          <select>
            <option value="introduction-to-social-deu.php" selected>DEU</option>
            <option value="introduction-to-social-eng.php">ENG</option>
          </select>
        </div>
        <nav>
          <ul class="main">
      ...
      <div class="row px-4">
        <div class="col-md-6">
          <div class="banner_l4_title Banner_l3_title cst_mar">
            <h1 class="banner_title" style="    margin-top: -4rem;">Warum sich das<br>
              Gastgewerbe sozial<br>
              engagieren muss</h1>
        ...
        <div class="col-md-6">
          <div class="banner_l3_img energy_banner">
            <img src="./images/safe_food/s1.svg" class="img-fluid pl-5" style="    width: 90%;
    margin-left: 0rem;">
          </div>
        </div>
      </div>
  ...
  <section class="section3-inners no-print">
  ...
  <section class="section3-inners no-print">
    <div class="section3-inner align-normal big_issues">
      ...
      <div class="right-content">
        <p>Da die Gastronomiebranche viele Menschen beschäftigt, spielt jedes Restaurant, unabhängig von seiner Größe und Art, eine wichtige Rolle für die Wirtschaft und die lokale Gemeinde. Doch leider halten sich viele Unternehmen im Gastgewerbe immer noch nicht an die Gesetze. Es mangelt an grundlegenden vorbildlichen Vorgehensweisen und manchmal ist das erforderliche Wissen einfach nicht bekannt und/oder verfügbar. Arbeitnehmende, deren grundlegende Rechte nicht geschützt sind, wirken sich aber nicht nur negativ auf ihr Restaurant, sondern auch auf die umliegende Gemeinde aus. Die Effizienz eines Restaurants, die Lebensmittelqualität und der Gesamterfolg Ihres Betriebs hängen in hohem Maße von engagiertem Personal ab.</p>
      </div>
    </div>
  </section>
