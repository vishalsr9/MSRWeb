...
<header>
    <div class="container  no-print">
        <div class="logo">
        <a href="gr-page1.php">  <img src="images/metro-logo.svg" /></a>
        </div>
        <div class="header-menu">
            <div class="menu-ham">
                <ul>
                <li class="menu-click" ="openNav()">
...
<a href="javascript:void(0)" class="closebtn" ="closeNav()">&times;</a>
  ...
  <a href="gr-page1.php">Home</a>
    <a href="gr-page2.php">My Sustainable Restuarant</a>
    <a href="gr-page2.php">The MSR Chapter Guide</a>
    <a href="gr-page3.php">Introduction to Sustainable Menu</a>
	<a href="gr-page4.php">Explore Sustainable Menu</a>
  </div>
</div>
			</li>
                </ul>
...
<select>
  <option value="gr-page4.php" selected>DEU</option>
  <option value="page4.php">ENG</option>
</select>
</div>
        </div>
    </div>
...
Reduzieren Sie den Umfang Ihrer Speisekarte</button>
</div>
</div>
<div class="item">
<div class="inner-item">
<button class="modal-toggle8">
Binden Sie Ihre Mitarbeitende von Anfang an ein. Erklären Sie, was Sie vorhaben und warum.</button>
</div>
</div>
<div class="item">
<div class="inner-item">
...
Proteine bestehen aus etwa zwanzig Aminosäuren und je nachdem wie wir uns ernähren, nehmen wir eine unterschiedliche Menge von Aminosäuren durch unsere Ernährung auf. Deshalb ist es wichtig, eine Vielzahl von unterschiedlichen Lebensmitteln zu sich zu nehmen, um die richtige Auswahl an Aminosäuren zu erhalten. Grundsätzlich können Proteine aufgrund ihres Aminosäuregehalts in vollständige (Fleisch, Fisch, Eier, Milch, Käse) und unvollständige (Bohnen, Nüsse, Samen, Tofu usw.) Eiweiße unterschieden werden. Unvollständiges Eiweiß kann wertvolle Aminosäuren liefern, wenn es z. B. in einem Gericht mit Reis und Erbsen gemischt werden. 
                    ...
                    <li>
                        ...
                        <h5>Bewusster Konsum von Proteinen</h5>
        ...
        <section class="section-highlight-withimages  section4-5 no-print">
            ...
            <ul>
                    ...
                    <div class="circle-content more-text">
                        ...
                        <p>Zeigen Sie, wo Ihre Zutaten herkommen und wer sie produziert hat. Erklären Sie die Nachhaltigkeitslabels Ihrer Zutaten
                        <span id="more7">(Überprüfen Sie zuerst, ob der Eigentümer des Label-Programms dies zulässt, und stellen Sie sicher, dass Sie die Zertifikate zur Verfügung haben). Informieren Sie Ihre Kunden darüber, wie die Zutat hergestellt wird. Erklären Sie, wenn es von einem lokalen Bauern stammt, der nachhaltige Prinzipien befolgt, sich aber gegen eine Zertifizierung entschieden hat. Es ist wichtig, dies Ihren Kunden deutlich zu machen. Heben Sie Gerichte mit Gemüse und Vollkorn hervor. Erklären Sie allgemein Ihre Nachhaltigkeitsphilosophie und erzählen Sie, wo immer möglich, die nachhaltige Geschichte Ihrer Gerichte.</span>
                        
                    </p>
                    <button href="#"  class="read-text" id="myBtn7">WEITERLESEN</button>
                    </div>
                    </li>
                    <li>
                    <div class="circle-content more-text">
                    ...
                    <div class="circle-content more-text">
                        ...
                        <div><p>Erwägen Sie, Ihrer Website und Ihren Social-Media-Seiten Informationen über die <a href="https://www.metro.de/nachhaltigkeit/lieferkette-rueckverfolgbarkeit"> Herkunft </a> Ihrer Zutaten hinzuzufügen
                        <div id="more8">sowie in gedruckter Form oder auf Ihrem Menüdisplay. Es spart Platz in den einzelnen Gerichtbeschreibungen.</div>
                        </p></div>
                        <button href="#"  class="read-text" id="myBtn8">WEITERLESEN</button>
                        </div>
                    </li>
            ...
            <ul>
                    ...
                    <div class="circle-content more-text">
                        ...
                        <div class="more-text"><p>Bedenken Sie, dass viele Gäste daran gewöhnt sind, nach dem Geschmack und dem Preis zu entscheiden. Über nachhaltige Zutaten wird sich meist erst danach Gedanken gemacht.  </p>
                            <div id="more6">Konzentrieren Sie sich also zunächst auf die Geschmacksbeschreibung. Fügen Sie entsprechend Ihrer Zielgruppe Beschreibungen hinzu, die diese ansprechen. Zum Beispiel: 
                                <ul>
...
(Hausgemachter Auflauf mit gemischten Bio-Bohnen, Bio-Tomaten und geräuchertem Pfeffer. Serviert mit einer Beilage aus Wildreis. Eine köstliche und sättigende Mahlzeit aus gesunden Proteinen!)
                    ...
                    <div class="circle-content more-text">
                        ...
                        <p>Stellen Sie sicher, dass Ihre Mitarbeitende die Informationen sachkundig und überzeugend vermitteln können.</p>
                        </div>
                    </li>
...
Wählen Sie eine passende Mahlzeit!</p>
                    ...
                    <li class="accordian3">
                    <div class="collapsible__header">WIR MAG KEINEN ABFALL</div>
                        <p class="collapsible__content">Wir verwandeln unser ungenutztes Brot in Semmelbrösel und Zutaten für unsere Gerichte. <br>
                           ...
                           <br>
                           Wenn sich herausstellt, dass Sie etwas zu viel auf Ihrem Teller haben. Den Rest geben wir Ihnen mit nach Hause.</p>
                    </li>
                    <li  class="accordian4">
                    <div class="collapsible__header">GEHEN</div>
                        <p class="collapsible__content">Wenn Sie es nicht selbst zu Lenas Küche schaffen oder es eilig haben, woanders hinzugehen, haben wir einen Liefer- und Abholservice. Unsere Behälter sind zu Hause kompostierbar. In Kürze bieten wir ein Containerpfandsystem an, damit Sie noch mehr Verpackungen für die Mülltonne sparen können! <br> Sehen Sie sich diesen Bereich an..</p>
                    </li>
                            </ul>
                            </section>
...
Denken Sie daran: Farm-to-Table-Restaurants sind bei Restaurantbesuchern sehr beliebt. Bringen Sie Ihre Gäste mit dem Ursprung von Lebensmitteln in Kontakt, indem Sie mit ihnen über Ihre Speisekarte sprechen. Erklären Sie, warum Sie die Änderungen vorgenommen haben. Wenn Sie Informationen zur Rückverfolgbarkeit auf Ihrer Speisekarte oder Ihrer Website angeben, erklären Sie, wie das funktioniert. Als Betrieb haben Sie einen viel größeren Einfluss auf Ihre Region, wenn Ihre Gäste und Mitarbeitende verstehen, was Sie tun. Eventuell lassen sich einige von Ihren Gästen bei der nächsten Einkaufsentscheidung von Ihnen inspirieren. Ihr Einfluss könnte größer sein, als Sie denken! 
            ...
            <div class="mid-content cation-plan-section">
                <ul>
                    ...
                    <span class="checkmark"></span>
                        ...
                        <p>
                            Informieren und beziehen Sie Ihre Mitarbeitende mit ein
                        </p>
                    </li>
                    <li>
                       <label class="check-wrap">
        ...
        <div class="top-content5">
                ...
                <ul>
                  <li>
                       <a href="https://www.menukithd.com/" target="_blank"> <img src="images/logo-dish.png" /></a>
                        ...
                        <li>
                        <a href="https://www.dish.co/XX/en/"  target="_blank">  <img src="images/Dish_Logo.svg" /></a>
                        </li>
                        <li>
                        ...
                        <li>
                        <a href="#"  target="_blank">  <img src="images/Eitiketten.png" /></a>
</li>
                ...
                <div class="top-content5">
                    <h3>METRO  Angebot</h3>
                    <!-- <p>METRO stellt nützliche unterstützende Tools zur Verfügung um Sie auf Ihrer MSR-Reise zu unterstützen</p> -->
                </div>
                <div class="bottom-content5">
                <ul>
                    <li>
                       <a href="#"  target="_blank"> <img src="images/Logo_METRO-Regio_weiss.png" /></a>
                        </li>
                        <li>
                        <a href="#"  target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 373 192" width="373" height="192">
...
<li>
                        <a href="#"  target="_blank">METRO <br> Serviceverpackungen </a>
</li>
                    </ul>
                    </div>
</div>
...
<div class=" vegan-modal">
    ...
    <div class="modal-wrapper1 modal-transition1">
        ...
        <svg class="icon-close icon" viewBox="0 0 32 32"><use xlink:href="#icon-close">
  ...
  <div class="eng-modal">
    ...
    <div class="modal-wrapper1 modal-transition1">
      ...
      <div class="modal-body1">
        <div class="modal-content1 flexi-cont">
        <h4>
Binden Sie Ihre Mitarbeitende von Anfang an ein. Erklären Sie, was Sie vorhaben und warum.
          </h4>
          <p>Binden Sie Ihre Mitarbeitende von Anfang an ein. Erklären Sie, was Sie vorhaben und warum.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class=" redu-modal">
    ...
    <div class="modal-wrapper1 modal-transition1">
      ...
      <div class="modal-body1">
        ...
        <div class="modal-content1 flexi-cont">
          <h4>
Reduzieren Sie den Umfang Ihrer Speisekarte</h4>
  ...
  <div class=" source-modal">
    ...
    <div class="modal-wrapper1 modal-transition1">
      ...
      <div class="modal-body1">
        <div class="modal-content1 flexi-cont">
        <h4>
  Beziehen Sie Ihre Produkte lokal, regional und saisonal</h4>
...
<div class="modal1">
    ...
    <div class="modal-wrapper1 modal-transition1">
      <div class="modal-header1">
        <button class="modal-close1 modal-toggle1"><svg class="icon-close icon" viewBox="0 0 32 32"><use xlink:href="#icon-close"></use></svg></button>
