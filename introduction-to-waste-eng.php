        ...
        <div class="container">
            ...
            <div class="new_header header-menu">
                ...
                <div class="custom__select top-mar-less">
                    <select>
                        <option value="introduction-to-waste-deu.php">DEU</option>
                        <option value="introduction-to-waste-eng.php" selected>ENG</option>
                    </select>
                </div>
                <nav>
                    <ul class="main">
    ...
    <section class="didyouknow_contents waste_foot_l3 no-print energy_mar">
        <div class="col-md-10 offset-md-1">
            ...
            <div class="row border-top">
                ...
                <div class="col-md-6">
                    <div class="didyouknow_2culumn">
                        <img src="./images/safe_food/w3.svg" class="px-4 dis_img2">
