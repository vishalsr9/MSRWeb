    ...
    <div class="container-full">
        <div class="page-3_stage">
            <section class="section1 mt-4">
                ...
                <div class="col-md-6">
                    <img src="./images/safe_food/Asset 67.svg" class="px-4">
                </div>
            </section>
            ...
            <section class="section3-inner align-normal">
                <div class="left-content">
            ...
            <section class="section4 padr-60px">
                ...
                <div class="w50-per mt-5">
                    <img src="./images/safe_food/Asset 9.svg" class="img-fluid px-5">
                </div>
            </section>
            ...
            <div class="fotter-right-top">
                ...
                <div class="footer-links link2">
                    <ul>
                        ...
                        <li>
                            <a href="use-https://www.metroag.de/en/terms-of-use" title="" target="_blank">Terms of Use</a>
                        </li>
                        <li>
                            <a href="contact-https://www.metroag.de/en/contact" title="" target="_blank">Contact</a>
                        </li>
                    </ul>
                </div>
