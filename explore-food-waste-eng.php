...
<body class="page4-page">
  ...
  <script>
    ...
    function starter() {
      var lcook = getCookie("likedCook3e");
      var dlcook = getCookie("dislikedCook3e");
      if (lcook) {
        $(".cy").addClass("cyliked");
    ...
    function liked() {
      var lcook = getCookie("likedCook3e");
      if (lcook) {
        eraseCookie("likedCook3e");

      } else {
        setCookie("likedCook3e", "1", 365);

      }
      eraseCookie("dislikedCook3e");
      starter();
    };
    ...
    function disliked() {
      ...
      if (dlcook) {
        ...
        setCookie("dislikedCook3e", "1", 365);
      }
      eraseCookie("likedCook3e");
      starter();
    };
